# -*- coding: utf-8 -*-
#
# NHIS Systems Documentation documentation build configuration file, created by
...
htmlhelp_basename = 'NHISSystemsdoc'
...
man_pages = [
    (master_doc, 'jprpsystem', u'JPRP Documentation',
     [author], 1)
]
